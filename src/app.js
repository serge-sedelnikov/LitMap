...
export class App {
  ...
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: ['feedback'], name: 'feedback', moduleId: './components/feedback', nav: true, title:this.i18n.i18next.t('app.feedback') },
      // { route: ['adm'], name: 'admin', moduleId: './components/admin', nav: false, title:this.i18n.i18next.t('app.admin') }
    ]);
