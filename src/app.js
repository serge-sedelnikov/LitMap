...
export class App {
  ...
  configureRouter(config, router) {
    ...
    var menuItems = [
      ...
      { route: ['http://xn--l1adgmc.xn----itbklch6ag0gq.xn--p1ai/'], name: 'forum', moduleId: 'http://xn--l1adgmc.xn----itbklch6ag0gq.xn--p1ai/', nav: true, title:'Форум', settings: {roles: [], target: 'blank'} },
